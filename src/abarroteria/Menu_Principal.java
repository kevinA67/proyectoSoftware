...
//        tamanioImg(jlblLogo, "src/Imagenes/supermercado_ABC_sinfondo.png");
        /*validacionPermisos();
...
//    }
    ...
    private void initComponents() {
        ...
        setTitle("ABARROTERIA ABC");

        jPanel2.setBackground(new java.awt.Color(237, 120, 74));

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/barra-de-menus.png"))); // NOI18N
        ...
        jpMenu1.setBackground(new java.awt.Color(0, 51, 102));
        jpMenu1.setPreferredSize(new java.awt.Dimension(170, 369));
        ...
        jbtnCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/clientesicon.png"))); // NOI18N
        ...
        jbtnEditorial.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/proveedoricon.png"))); // NOI18N
        jbtnEditorial.setText("Proveedores");
        ...
        jbtnVenta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ventasicon.png"))); // NOI18N
        ...
        jbtnUsuarios.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/usericon.png"))); // NOI18N
        ...
        jbtnAyuda.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ayudaicon.png"))); // NOI18N
        ...
        jbtnReportes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/reporticon.png"))); // NOI18N
        ...
        jlblLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/supermercado_ABC_sinfondo.png"))); // NOI18N

        jDesktopPane1.setLayer(jPanel2, javax.swing.JLayeredPane.DEFAULT_LAYER);
        jDesktopPane1.setLayer(jpMenu1, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        jDesktopPane1Layout.setVerticalGroup(
            ...
            .addGroup(jDesktopPane1Layout.createSequentialGroup()
                ...
                .addGroup(jDesktopPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jDesktopPane1Layout.createSequentialGroup()
                        .addComponent(jpMenu1, javax.swing.GroupLayout.DEFAULT_SIZE, 411, Short.MAX_VALUE)
                        .addGap(25, 25, 25))
                    .addGroup(jDesktopPane1Layout.createSequentialGroup()
                        .addGap(6, 6, 6)
...
//        ra.show();
    ...
    private void jbtnEditorialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnEditorialActionPerformed
        JInternalProveedor re = new JInternalProveedor();
    ...
    private void jbtnClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnClienteActionPerformed
        JInternalClientes rc = new JInternalClientes();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jpMenu1.getX() == 0) {
            desplace.desplazarIzquierda(jpMenu1, jpMenu1.getX(), -170, 10, 10);
        } else if (jpMenu1.getX() == -170) {
            desplace.desplazarDerecha(jpMenu1, jpMenu1.getX(), 0, 10, 10);
        }
